...
def encrypt(pk, size, q, t, poly_mod, pt):
    ...
    print("[+] PT -> M polynomial): {}".format(m))
    print("")
    ...
    print("[+] e1 polynomial): {}".format(e1))
    print("")
    print("[+] e2 polynomial): {}".format(e2))
    print("")
...
if __name__ == "__main__":
    ...
    ct5 = add_cipher(ct3, ct4, q, poly_mod)
     ...
     # ct5 = ct1 + ct2 -> 93
    ct6 = add_cipher(ct1, ct2, q, poly_mod)
    ...
    print("[+] polynomial modulus degree - N): {}".format(n))
    print("[+] ciphertext modulus        - q): {}".format(q))
    print("[+] plaintext modulus         - t): {}".format(t))
    print("[+] polynomial modulus        - poly_mod): {}".format(poly_mod))
